...
Old approach
Get-CIMInstance -ClassName CIM_LogicalDevice | Select-Object name, description, deviceID | where-object {$_.description -match 'USB'} | Export-CSV -path C:\$folderName\$Path`.csv
#>
